  ...
  if (snap.current === "Mitochondria") {
    return (
      <div className="h-full md:flex md:flex-col md:justify-center">
        ...
        <h1 className="text-xl ">Mitochondria are membrane-bound cell organelles (mitochondrion, singular) that generate most of the chemical energy needed to power the cells biochemical reactions. Chemical energy produced by the mitochondria is stored in a small molecule called adenosine triphosphate (ATP).</h1>
      </div>
    )
  }
